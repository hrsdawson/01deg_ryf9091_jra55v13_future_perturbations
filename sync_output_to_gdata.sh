...
#PBS -l ncpus=1
#PBS -l wd
#PBS -l storage=gdata/ik11+gdata/e14+gdata/cj50+scratch/e14+scratch/oz91
...
GDATADIR=/g/data/cj50/access-om2/raw-output/access-om2-01/01deg_jra55v13_ryf9091_ssp245_mw
